...
export const Reply = (props: ReplyProps) => {
	...
	const postText = codemark != null ? codemark.text : props.post.text.replace(/#grok#/g, "");
	...
	const isGrok = props.post.text.startsWith("#grok#");

	const author = isGrok ? { username: "Grok", id: "fake" } : props.author ?? { username: "???" };
