...
import { lightTheme } from "@codestream/sidebar/src/themes";
import { CodeStreamState } from "@codestream/sidebar/store";
import { ContextState } from "@codestream/sidebar/store/context/types";
import * as providerSelectors from "@codestream/sidebar/store/providers/reducer";
import { TeamsState } from "@codestream/sidebar/store/teams/types";
...
import { Observability } from "@codestream/sidebar/Stream/Observability";
import { PaneState } from "@codestream/sidebar/src/components/Pane";
import {
...
import translations from "@codestream/sidebar/translations/en";
import { ConfigsState } from "@codestream/sidebar/store/configs/types";
import { isFeatureEnabled } from "@codestream/sidebar/store/apiVersioning/reducer";

jest.mock("@codestream/sidebar/store/apiVersioning/reducer");
jest.mock("@codestream/sidebar/webview-api");
jest.mock("@codestream/sidebar/store/providers/reducer");
