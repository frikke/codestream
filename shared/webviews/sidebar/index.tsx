...
import { logError, logWarning } from "@codestream/sidebar/logger";
...
import { updateConfigs } from "@codestream/sidebar/store/configs/slice";
import { fetchReview } from "@codestream/sidebar/store/reviews/thunks";
import { switchToTeam } from "@codestream/sidebar/store/session/thunks";
...
const pollToCheckMaintenanceMode = async function () {
	const response: any = await HostApi.instance.send(
		PollForMaintenanceModeRequestType,
		void {}
	);
