...
import { CardFooter, CardProps, getCardProps } from "@codestream/sidebar/src/components/Card";
import { ButtonRow, Dialog } from "@codestream/sidebar/src/components/Dialog";
...
} from "@codestream/sidebar/store/codeErrors/actions";
import { getCodeError, getCodeErrorCreator } from "@codestream/sidebar/store/codeErrors/reducer";
import {
	api,
	copySymbolFromIde,
	fetchErrorGroup,
...
} from "@codestream/sidebar/store/codeErrors/thunks";
import {
	getGrokPostLength,
	getThreadPosts,
	getPost,
	isGrokStreamLoading,
} from "@codestream/sidebar/store/posts/reducer";
import { isConnected } from "@codestream/sidebar/store/providers/reducer";
import {
...
import { isSha } from "@codestream/sidebar/utilities/strings";
import { emptyArray, replaceHtml } from "@codestream/sidebar/utils";
