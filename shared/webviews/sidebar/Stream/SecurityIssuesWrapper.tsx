...
import { Link } from "@codestream/sidebar/Stream/Link";
...
import { Modal } from "@codestream/sidebar/Stream/Modal";
import { InlineMenu, MenuItem } from "@codestream/sidebar/src/components/controls/InlineMenu";
import { SmartFormattedList } from "@codestream/sidebar/Stream/SmartFormattedList";
import { useRequestType } from "@codestream/sidebar/utilities/hooks";
import { ResponseError } from "vscode-jsonrpc";
import { Row } from "./CrossPostIssueControls/IssuesPane";
import Icon from "./Icon";
import Tooltip from "./Tooltip";
import { ObservabilityLoadingVulnerabilities } from "@codestream/sidebar/Stream/ObservabilityLoading";
...
function VulnView(props: { vuln: Vuln; onClose: () => void }) {
	const { vuln } = props;
	HostApi.instancenstancenstancenstance.track("Vulnerability Clicked");
	return (
					...
					<div className="contents">
						<CardTitle>
							...
							<div
								...
								onClick={() => {
									if (vuln.url) {
										HostApi.instancenstancenstancenstance.send(OpenUrlRequestType, {
											url: vuln.url,
										});
									}
								}}
