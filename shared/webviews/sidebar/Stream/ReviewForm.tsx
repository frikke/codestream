...
import { editReview } from "@codestream/sidebar/store/reviews/thunks";
import {
	setCurrentRepo,
	setCurrentReview,
	setNewPostEntry,
} from "@codestream/sidebar/store/context/actions";
import { SelectPeople } from "@codestream/sidebar/src/components/SelectPeople";
import HeadshotMenu from "@codestream/sidebar/src/components/HeadshotMenu";
import { Headshot } from "@codestream/sidebar/src/components/Headshot";
import { WebviewPanels } from "@codestream/protocols/api";
import { ReviewShowLocalDiffRequestType } from "@codestream/sidebar/ipc/sidebar.protocol";
...
class ReviewForm extends React.Component<Props, State> {
	...
	async addIgnoreFile(filename: string) {
		...
		return await HostApi.instance.send(AddIgnoreFilesRequestType, {
			repoPath,
			path: filename,
		});
	}
