...
import { authenticate } from "@codestream/sidebar/Authentication/actions";
import { errorDismissed } from "@codestream/sidebar/store/connectivity/actions";
import { Middleware } from "redux";
import { AppDispatch, CodeStreamState } from "..";
import { RestartRequestType } from "../../ipc/sidebar.protocol";
...
class Poller {
	...
	constructor(
		...
		private readonly _executor: PollExecutor
	) {}
