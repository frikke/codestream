...
import { PullRequest } from "@codestream/sidebar/ipc/sidebar.protocol.common";
import { logError } from "@codestream/sidebar/logger";
import { setProviderError } from "@codestream/sidebar/store/codeErrors/thunks";
...
} from "@codestream/sidebar/store/providerPullRequests/slice";
