...
import { ReloadWebviewRequestType } from "../ipc/sidebar.protocol";
...
export const ReloadAllWindows = (props: PropsWithChildren<ReloadAllWindowsProps>) => {
	...
	const handleClick = async event => {
		...
		HostApi.sidebarInstance.track("NR Switched to Staging");
		HostApi.sidebarInstance.send(ReloadWebviewRequestType, void undefined);
	};
