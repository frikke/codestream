...
import { INrqlClient } from "./newrelic/INrqlClient";
	...
	implements INrqlClient
{
	...
	private _clmProvider = new ClmManager(this);
	 ...
	 * @memberof NewRelicProvider
	 */
	public async getObservabilityEntityRepos(
		repoId: string,
		skipRepoFetch = false,
		force = false
  ...
  `;
	...
	public errorLogIfNotIgnored(ex: Error, message: string, ...params: any[]): void {
